...
import 'package:xigua_read/model/novel_book_review.dart';
import 'package:xigua_read/model/novel_detail.dart';
import 'package:xigua_read/model/novel_short_comment.dart';
import 'package:xigua_read/novel/view/widget/novel_book_intro_appbar_header_view.dart';
import 'package:xigua_read/novel/view/widget/novel_book_intro_book_review_view.dart';
import 'package:xigua_read/novel/view/widget/novel_book_intro_bottom_menu_view.dart';
import 'package:xigua_read/novel/view/widget/novel_book_intro_header_tag_view.dart';
...
class _NovelBookIntroViewState
  ...
  Widget buildView(BuildContext context, NovelBookIntroViewModel viewModel) {
    ...
    if (bgEndColor == null && detailInfo?.cover != null) {
      initPageTopColor(
  ...
  List<Widget> _headerSliverBuilder(
    ...
    List<Widget> headerContentList = [
      // 头部折叠
      SliverAppBar(
        // 标题左侧显示的一个控件, 在首页通常显示应用的logo，在其他页面显示为返回按钮
        leading: IconButton(
