...
class BookshelfBean {
	...
	@override
	String toString() {
		return 'BookshelfBean{title: $title, image: $image, readProgress: $readProgress, bookUrl: $bookUrl, bookId: $bookId, offset: $offset, isReversed: $isReversed, chaptersIndex: $chaptersIndex}';
	}
